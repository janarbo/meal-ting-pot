    ...
    <div className="flex">
        <div>
            <ul className="list-inside">
                <li>
                    <button
                        className="bg-[#829b7a] bg-opacity-80 hover:opacity-80 text-white font-bold py-2 px-4 rounded-full mb-2 w-full"
                ...
                <li>
                    ...
                    <li>
                        <button
                            className="bg-[#829b7a] hover:opacity-80 text-white font-bold py-2 px-4 rounded-full w-full"
