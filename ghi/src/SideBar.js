    ...
    <div className="flex">
        <div>
            <ul className="list-inside">
                <li>
                    <button
                        className="bg-[#8cc07b] hover:opacity-80 text-white font-bold py-2 px-4 rounded-full mb-2 w-full"
                ...
                <li>
                    ...
                    <li>
                        <button
                            className="bg-[#8cc07b]  text-white font-bold py-2 px-4 rounded-full w-full"
