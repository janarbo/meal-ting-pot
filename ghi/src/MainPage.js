...
const MainPage = () => {
  ...
  <div className="min-h-screen font-sans">
        ...
        {tags &&
          tags.map((tag) => (
            <button
              ...
              className="text-white  py-2 px-2 border-none bg-[#8cc07b] rounded-full mb-4 hover:opacity-70 w-full"
            >
              {tag.name}
            </button>
          ))}
    ...
    <div className="w-full pt-3 pb-10 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
